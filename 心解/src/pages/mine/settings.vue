    ...
    <view class="settings-list">
      ...
      <view class="setting-group">
        ...
        <view class="setting-item">
          ...
          <view
            class="toggle"
            :class="{ 'toggle-on': appState.settings.anonymousDefault }"
            @click="toggleSetting('anonymousDefault')"
          >
            <view class="toggle-knob" />
          </view>
        </view>
        <view class="setting-item pressable" @click="doClearCache">
...
import { appState, updateSetting, persistAppState } from '../../store/useAppStore.js'
...
.setting-group { margin-bottom: 56rpx; }

.group-title {
  display: block;
  font-size: $fs-label-sm; color: rgba($color-on-surface-variant, 0.5);
...
.setting-label {
  display: block; font-size: $fs-body-lg; color: $color-on-surface; margin-bottom: 8rpx;
}
.setting-desc {
...
.setting-value {
  font-size: $fs-body-md; color: rgba($color-on-surface-variant, 0.5);
}
